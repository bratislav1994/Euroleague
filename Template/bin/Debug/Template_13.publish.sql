...
GO
PRINT N'Creating [dbo].[Osoba]...';


GO
CREATE TABLE [dbo].[Osoba] (
    [LICBR_OSOBA] CHAR (64) NOT NULL,
    [Klub_ID_KLB] CHAR (64) NOT NULL,
    CONSTRAINT [Osoba_PK] PRIMARY KEY CLUSTERED ([LICBR_OSOBA] ASC)
);
...
BEGIN
	set @isOk = 'ok';
	declare @startDateFromDB date, @endDateFromDB date;
	declare @rez_id varchar(15), @hala_ozn varchar(15);
	declare @RezervacijaCursor as cursor;
