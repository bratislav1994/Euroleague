...
GO
PRINT N'Dropping [dbo].[IgracIgra_StatistickiPodaci_FK]...';


GO
ALTER TABLE [dbo].[IgracIgra] DROP CONSTRAINT [IgracIgra_StatistickiPodaci_FK];
...
GO
PRINT N'Dropping [dbo].[Radnik_Hala_FK]...';


GO
ALTER TABLE [dbo].[Radnik] DROP CONSTRAINT [Radnik_Hala_FK];
...
GO
PRINT N'Dropping [dbo].[Utakmica_KonferencijaZaMedije_FK]...';


GO
ALTER TABLE [dbo].[Utakmica] DROP CONSTRAINT [Utakmica_KonferencijaZaMedije_FK];
